...
namespace Bank1
{
    internal class Bank1
    {
        ...
        enum enMainMenuOptions { eListClients = 1, eAddNewClient = 2, eDeleteClient = 3, eUpdateClient = 4, eFindClient = 5, eExit = 6 }
        ...
        static void PrintClientRecordLine(stClient client)
        {
            ...
            Console.WriteLine($"| {client.accountBalance.ToString().PadRight(12)}");
        ...
        static void SaveClientListToFile(string fileName, List<stClient> lClients)
        {
        ...
        static void DeleteClientByAccountNumber(string fileName, string accountNumber, ref List<stClient> lClients)
        {
            ...
            if (FindClientByAccountNumber(fileName, accountNumber, lClients, ref client))
            {
                ...
                if (char.ToUpper(confirm) == 'Y')
                {
                    ...
                    SaveClientListToFile(fileName, lClients);
        ...
        static short ReadMainMenuOption()
        {
            ...
            do
            {
                ...
                Console.Write("Choose What You Want to Do? [1 to 6]? ");
